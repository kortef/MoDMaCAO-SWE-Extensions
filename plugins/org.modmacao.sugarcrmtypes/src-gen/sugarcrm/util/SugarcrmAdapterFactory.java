 ...
 * @generated
 */
public class SugarcrmAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected SugarcrmSwitch<Adapter> modelSwitch =
		new SugarcrmSwitch<Adapter>() {
			@Override
			public Adapter caseSugarcrmapplication(Sugarcrmapplication object) {
				return createSugarcrmapplicationAdapter();
			}
			@Override
			public Adapter caseSugarcrmdatabase(Sugarcrmdatabase object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link sugarcrm.Sugarcrmapplication <em>Sugarcrmapplication</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createSugarcrmapplicationAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link sugarcrm.Sugarcrmdatabase <em>Sugarcrmdatabase</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createSugarcrmdatabaseAdapter() {
		return null;
	}
